    ...
    <div class="row">
      <div class="col s12 m3">
          <ul id="slide-out" class="sidenav sidenav-fixed">
              ...
              <li><a href="index.php?p=dashboard"><i class="material-icons"></i>Dashboard</a></li>
              <li><a href="index.php?p=registrasi"><i class="material-icons"></i>Registrasi</a></li>
              <li><a href="index.php?p=pengaduan"><i class="material-icons"></i>Pengaduan</a></li>
              <li><a href="index.php?p=respon"><i class="material-icons"></i>Respon</a></li>
              <li><a href="index.php?p=user"><i class="material-icons"></i>User</a></li>
              <li><a href="index.php?p=laporan"><i class="material-icons"></i>Laporan</a></li>
              <li>
                  <div class="divider"></div>
              </li>
              <li><a class="waves-effect" href="../index.php?p=logout"><i class="material-icons"></i>Logout</a></li>
          </ul>
